            ...
            if (block_type != prev_type and prev_type) or (
                ...
                text_blocks.append(
                    FullyMergedBlock(
                        ...
                        block_type=(
                            prev_type if prev_type else settings.DEFAULT_BLOCK_TYPE
                        ),
                        page_end=False,
                    )
                )
...
def apply_markdown_to_block(block):
    styled_text = ""
    ...
    if block.block_type == "Title":
        ...
        return f"\n```\n{block.prelim_text}\n```\n"  # Use prelim_text for code to preserve formatting
        ...
        return escape_markdown(
            styled_text
        )  # Escape markdown characters for regular text
